 ...
 */
public class AveragePricePerRegion {
  ...
  public static void main(String[] args) throws Exception {
     ...
     */
    job.setJarByClass(AveragePricePerRegion.class);
     ...
     */
    job.setMapperClass(AveragePricePerRegionMapper.class);
    job.setReducerClass(AveragePricePerRegionReducer.class);
