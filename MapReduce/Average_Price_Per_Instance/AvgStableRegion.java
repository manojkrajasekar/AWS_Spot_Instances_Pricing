...
public class AvgStableRegion {
  ...
  public static void main(String[] args) throws Exception {
     ...
     */
    job.setJarByClass(AvgStableRegion.class);
     ...
     */
    job.setMapperClass(AvgStableRegionMapper.class);
    job.setReducerClass(AvgStableRegionReducer.class);
