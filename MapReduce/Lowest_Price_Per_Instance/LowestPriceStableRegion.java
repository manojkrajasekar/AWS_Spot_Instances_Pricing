 ...
 */
public class LowestPriceStableRegion {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length != 2) {
      System.out.printf(
          "Usage: AwsPriceDetails <input dir> <output dir>\n");
      System.exit(-1);
    }
     ...
     */
    job.setJarByClass(LowestPriceStableRegion.class);
    
    /*
     * Specify an easily-decipherable name for the job.
     * This job name will appear in reports and logs.
     */
    job.setJobName("AWSPricing");
     ...
     */
    job.setMapperClass(LowestPriceStableRegionMapper.class);
    job.setReducerClass(LowestPriceStableRegionReducer.class);
